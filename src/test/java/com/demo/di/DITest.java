...
import com.demo.di.demo2.Computer;
import com.demo.di.demo1.Student;
import com.demo.di.demo3.Solider;
import com.demo.di.demo4.Person;
...
public class DITest {
    ...
    @Test
    public void test() {
        ApplicationContext context = new ClassPathXmlApplicationContext("di/dependency_inject.xml");
